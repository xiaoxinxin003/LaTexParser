...
public class FlexibleRichTextView extends LinearLayout {
    private final static String TAG = "yxx-FlexibleTV";
    ...
    public void setToken(List<TOKEN> tokens, List<Attachment> attachmentList) {
        ...
        for (final Object o : result) {
            if (o instanceof TextWithFormula) {
                ...
                textView.setFormulaTextSize(mTextSize);
                textView.setFormulaLocation(mLeftMargin, mTopMargin);
                Log.d(TAG, "setToken: set text with formula " + textWithFormula);
    ...
    public void setTextLocation(float leftMargin, float topMargin) {
        this.mLeftMargin = leftMargin;
        this.mTopMargin = topMargin;
        Log.d(TAG, "setTextLocation: leftMargin is: " + leftMargin + "  topMargin is: " + topMargin);
    }
